# Shadow Bot Source Implementation Guide

**Path**: `hype-usdc-dnmm/shadow-bot/src`

**Description**: TypeScript sources powering the DNMM shadow bot, including configuration loaders, adapters, multi-run orchestration, metrics, and reporting utilities.
...
## Change Log
- 2025-10-04: Added guide to align with root template while expanding config parameter coverage.
