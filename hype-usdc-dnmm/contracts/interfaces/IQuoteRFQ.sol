...
interface IQuoteRFQ {
    ...
    function hashQuote(QuoteParams calldata params) external pure returns (bytes32);

    function hashTypedDataV4(QuoteParams calldata params) external view returns (bytes32);
