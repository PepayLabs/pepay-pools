...
> **Implementation Update (2025-09-30):** Automated and manual target rebalancing have shipped; see `docs/REBALANCING_IMPLEMENTATION.md` for the final Solidity snapshots.
