...
contract InventoryTest is Test {
    ...
    function test_noPartial_when_above_floor() public {
        (uint256 amountOut, uint256 appliedAmountIn, bool isPartial) =
            Inventory.quoteBaseIn(1_000 ether, 1e18, 50, 2_000_000e6, 300, tokens);
    ...
    function test_partialFill_rounding_edges() public {
        ...
        (uint256 amountOut, uint256 appliedAmountIn, bool isPartial) =
            Inventory.quoteBaseIn(5_000_000 ether, 997e15, 75, quoteReserves, 300, tokens);
        if (isPartial) {
    ...
    function test_fuzz_partial_floor_invariant(uint256 reserves, uint16 floorBps, uint256 amountIn, uint256 mid)
        public
    {
