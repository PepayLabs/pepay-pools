# HYPE/USDC DNMM Performance Tests Implementation Guide

**Path**: `hype-usdc-dnmm/test/perf`

**Description**: Foundry performance, load, and gas instrumentation suites producing repeatable metrics for DNMM regressions.
