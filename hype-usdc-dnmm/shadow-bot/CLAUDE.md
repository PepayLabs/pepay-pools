...
## Change Log
- 2025-10-04: Multi-run pipeline now persists checkpoints, emits scoreboard JSON/Markdown reports, and surfaces derived KPIs + DNMM import metrics for side-by-side dashboards.
