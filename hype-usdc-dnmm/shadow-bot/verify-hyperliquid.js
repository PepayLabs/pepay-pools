...
async function testDirectCall() {
    ...
    try {
        ...
        // Decode
        const [value] = coder.decode(['uint64'], result);
...
async function testWrongPrecompile() {
    ...
    const [wrongValue] = coder.decode(['uint64'], wrongResult);
    ...
    const [rightValue] = coder.decode(['uint64'], rightResult);
...
async function testResponseFormat() {
    ...
    try {
        const [val] = coder.decode(['uint64'], result);
