...
## Change Log
- 2025-09-22: Added fork parity regression suite, preview↔settlement parity (base, quote, RFQ), timestamp regression guard, DoS gas campaign, and 5k-load metrics exports.
