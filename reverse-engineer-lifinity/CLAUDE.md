# Lifinity Reverse Engineering Guide

**Path**: `reverse-engineer-lifinity`

**Description**: Exploratory tooling, bytecode analysis, and decoded documentation used to map Lifinity v2 behaviour into the HyperEVM port.
...
## Change Log
- 2024-05-24: Template synced for reverse engineering assets.
